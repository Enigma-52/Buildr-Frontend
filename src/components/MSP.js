      ...
      <section className="bg-gradient-to-b from-black to-purple-300 text-white py-40 ">  {/* Added mb-24 for margin */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <button onClick={handleGetStarted} className="px-8 py-4 text-lg font-semibold bg-white text-black rounded-full hover:bg-purple-400 hover:text-white transition duration-300">Get Started</button>
          </div>
        </div>
      </section>
    );
