      ...
      <section className="bg-gradient-to-b from-black to-purple-300 text-white py-40 ">  {/* Added mb-24 for margin */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-4">Unlock Your Professional Potential</h2>
            <p className="text-xl mb-8">Experience unparalleled growth by showcasing your projects and skills on Buildr.</p>
